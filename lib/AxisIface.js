...
export const axisIface = {
  ...
  drawMajorGridLines: PropTypes.bool,
  ...
  majorGridColor: PropTypes.number,
  majorGridLineWidth: PropTypes.number,
  ...
  majorGridDashedLine: PropTypes.shape({
    lineLength: PropTypes.number,
    spaceLength: PropTypes.number,
    phase: PropTypes.number
  }),
  ...
  majorGranularity: PropTypes.number,
  majorGranularityEnabled: PropTypes.bool,
